...
HEADER  = ./lib/VectorArray.h ./lib/Vector.h ./lib/Parser.h ./lib/Distance.h ./lib/ExactNN.h ./lib/Manhattan.h ./lib/LSH.h ./lib/HashTable.h ./lib/HashFunction.h ./lib/HyperCube.h ./lib/Grids.h ./lib/DTW.h ./lib/CurvesParser.h ./lib/Initialization.h ./lib/RandomSelection.h ./lib/Cluster.h ./lib/KMeansInit.h ./lib/Assignment.h ./lib/Lloyds.h ./lib/Update.h ./lib/PAM.h ./lib/RangeSearch.h 
OBJS 	= VectorArray.o Vector.o Parser.o Distance.o ExactNN.o Manhattan.o LSH.o HashTable.o HashFunction.o HyperCube.o Grids.o DTW.o CurvesParser.o Initialization.o RandomSelection.o Cluster.o main.o KMeansInit.o Assignment.o Lloyds.o Update.o PAM.o RangeSearch.o
